...
# Dictionary to store the table data for Leogane
leogane_data = {
    'title': [
        'Commune Action Plan',
        'Project performance',
    ...
    'shared_links': [
        'https://go.mwater.co/cap_leogane',  # Placeholder for Commune Action Plan link
...
# Export to Excel
excel_file = './ui/components/leogane_sharedlinks.xlsx'
