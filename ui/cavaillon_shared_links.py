...
# Dictionary to store the table data for Cavaillon
cavaillon_data = {
    'title': [
        'Commune Action Plan',
        'Project performance',
    ...
    'shared_links': [
        'https://go.mwater.co/cavaillon_cap',  # Placeholder for Commune Action Plan link
...
df = pd.DataFrame(cavaillon_data)
...
# Export to Excel
excel_file = './ui/components/cavaillon_sharedlinks.xlsx'
