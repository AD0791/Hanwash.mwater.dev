...
# Dictionary to store the table data for Ferrier
ferrier_data = {
    'title': [
        'Commune Action Plan',
        'Project performance',
    ...
    'shared_links': [
        'https://go.mwater.co/ferrier_cap',  # Placeholder for Commune Action Plan link
...
# Export to Excel
excel_file = './ui/components/ferrier_sharedlinks.xlsx'
